import { toModifierDisplay, toModifierWithProficiencyDisplay } from "@/helpers/dndHelpers";
    ...
    return (
        <Box className="ability-box">
            ...
            <HStack className="justify-content-center" gap="4">
                <div>
                    <h4>{toModifierDisplay(ability.value)}</h4>
                    <small>Mod</small>
                </div>
                <div>
                    <h4>{toModifierWithProficiencyDisplay(ability.value, proficiencyBonus, ability.proficient)}</h4>
                    <small>Save</small>
                </div>
            </HStack>
        </Box>
